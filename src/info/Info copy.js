...
export const info = {
  ...
  miniBio: [
    ...
    {
      emoji: "💼",
      text: "React Native Developer @Durapid Technologies",
    },
    {
      emoji: "📧",
      text: "arun4dev@icloud.com",
    },
  ],
  socials: [
    {
    ...
    {
      link: "https://www.linkedin.com/in/arunk4it/",
      icon: "fa fa-linkedin",
      label: "linkedin",
    },
    {
      link: "https://twitter.com/arunk4it",
      icon: "fa fa-twitter",
      label: "twitter",
    },
  ...
  bio: "Hello! I'm Arun. I'm a software engineer at Durapid Technologies. I studied CompSci at AKTU, I enjoy long walks on the beach, and I believe artificial intelligence will inevitably rule us all one day. You should hire me!",
  skills: {
    proficientWith: [
      "react-native",
      "javascript",
